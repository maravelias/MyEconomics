package gr.maravelias.myeconomics.test_support;
...
/**
 * JUnit extension for providing system authentication in integration tests. Should be used in
 * {@code @ExtendWith} annotation on the test class.
 */
