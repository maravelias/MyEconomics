...
public interface UiMinimalRole {
  ...
  @ViewPolicy(
      viewIds = {
        "myec_MainView",
        "myec_Trader.list",
        "myec_BankAccount.list",
        "myec_BankAccount.detail",
        "flowui_AddConditionView",
        "flowui_GroupFilterCondition.detail",
        "flowui_PropertyFilterCondition.detail",
        "flowui_JpqlFilterCondition.detail",
        "myec_BankTransaction.list",
        "myec_BankTransaction.detail",
        "myec_ExpenseInvoice.list",
        "myec_ExpenseInvoice.detail",
        "myec_ViewTraderBalances.list",
        "myec_SupplierInfoView",
        "myec_TotalsView"
      })
  void main();
  ...
  @EntityAttributePolicy(
      entityClass = FilterValueComponent.class,
      attributes = "*",
      action = EntityAttributePolicyAction.MODIFY)
  ...
  @EntityAttributePolicy(
      entityClass = BankTransaction.class,
      attributes = "*",
      action = EntityAttributePolicyAction.MODIFY)
  ...
  @EntityAttributePolicy(
      entityClass = CommonEntity.class,
      attributes = "*",
      action = EntityAttributePolicyAction.MODIFY)
  ...
  @EntityAttributePolicy(
      entityClass = ExpenseInvoice.class,
      attributes = "*",
      action = EntityAttributePolicyAction.MODIFY)
  ...
  @EntityAttributePolicy(
      entityClass = ViewTraderBalances.class,
      attributes = "*",
      action = EntityAttributePolicyAction.VIEW)
